using ResultPlusPlus.Data_Access;
...
namespace ResultPlusPlus
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IRepository<Class>, SQLRepository<Class>>();
            container.RegisterType<IRepository<Student>, SQLRepository<Student>>();
            container.RegisterType<IRepository<Exam>, SQLRepository<Exam>>();
